...
function insert_order($order_details)
{
  ...
  $date = date('Y-m-d');
  $query = "insert into orders (customerid, amount, date, order_status, ship_name, ship_address, ship_city, ship_state, ship_zip, ship_country) values
  ...
  foreach($_SESSION['cart'] as $isbn => $quantity)
  {
    ...
    $result = $conn->query($query);
    $query = "insert into order_items (orderid, isbn, item_price, quantity) values
